...
import pageObjects.RegisterPageObjTest;
import utilities.DriverUtility;

public class RegisterStepCodes extends Base {

	RegisterPageObjTest registerPageObj = new RegisterPageObjTest();
	...
	public void user_click_on_Register() throws Throwable {
        ...
        DriverUtility.wait(10000);
        /* WebDriverWait wait = new WebDriverWait(driver, 5000);
        wait.until(ExpectedConditions.visibilityOf(clickOnRegister)); 
	...
	public void user_should_see_message_Your_Account_Has_Been_Created(String message) throws Throwable {
		...
		DriverUtility.wait(2000);
           Assert.assertNotEquals(registerPageObj.getSuccessfullAcctCreationMessage(), message);
